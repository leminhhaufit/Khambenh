...
public class TopicSubcriber {
	...
	private static TopicSubcriber instance=null;
	
	private TopicSubcriber() throws Exception {
	...
	public static TopicSubcriber getInstance() throws Exception
	{
		if (instance==null)
			instance = new TopicSubcriber();
		return instance;
	}
	...
	public void sendMessage(String xml) throws Exception
	{
		Session session = con.createSession(false, 	Session.CLIENT_ACKNOWLEDGE);
		Destination destination = (Destination) ctx.lookup("dynamicQueues/minhhau");
